...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','ShipEasy'); ?> - Sistem Pengiriman</title>
...
<div x-data="{mobileOpen: false, desktopOpen: true}" class="flex h-screen overflow-hidden">
    ...
    <aside :class="mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
        ...
        <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-1">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.dashboard')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.orders*')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('admin.customers.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.customers*')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('admin.couriers.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.couriers*')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('admin.zones.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.zones*')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('admin.rates.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.rates*')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('admin.reports.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('admin.reports*')?'active':'text-slate-600'); ?>">
            ...
            <?php elseif($r==='courier'): ?>
            <a href="<?php echo e(route('courier.dashboard')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('courier.dashboard')?'active':'text-slate-600'); ?>">
                <i class="fas fa-tachometer-alt w-5 text-center text-blue-400 flex-shrink-0"></i>
                <span x-show="desktopOpen || mobileOpen" class="text-sm font-medium">Dashboard</span>
            </a>
            <a href="<?php echo e(route('courier.orders.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('courier.orders*')?'active':'text-slate-600'); ?>">
            ...
            <?php elseif($r==='customer'): ?>
            <a href="<?php echo e(route('customer.dashboard')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('customer.dashboard')?'active':'text-slate-600'); ?>">
                <i class="fas fa-tachometer-alt w-5 text-center text-blue-400 flex-shrink-0"></i>
                <span x-show="desktopOpen || mobileOpen" class="text-sm font-medium">Dashboard</span>
            </a>
            <a href="<?php echo e(route('customer.orders.create')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('customer.orders.create')?'active':'text-slate-600'); ?>">
            ...
            <a href="<?php echo e(route('customer.orders.index')); ?>" @click="mobileOpen=false" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo e(request()->routeIs('customer.orders.index')?'active':'text-slate-600'); ?>">
    ...
    <div class="flex-1 flex flex-col overflow-hidden min-w-0">
        <header class="bg-white border-b border-blue-50 h-16 flex items-center justify-between px-4 md:px-6 shadow-sm flex-shrink-0">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-sm md:text-base font-semibold text-blue-900 truncate"><?php echo $__env->yieldContent('page-title','Dashboard'); ?></h1>
            </div>
            <div x-data="{drop:false}" class="relative flex-shrink-0">
                <button @click="drop=!drop" class="flex items-center gap-2 md:gap-3 hover:bg-blue-50 rounded-xl px-2 md:px-3 py-2 transition">
                    ...
                    <div class="hidden md:block text-left">
                        <p class="text-sm font-medium text-slate-700 whitespace-nowrap"><?php echo e(auth()->user()->name); ?></p>
                ...
                <div x-show="drop" @click.away="drop=false" x-transition
                    ...
                    <div class="px-4 py-2 border-b border-blue-50">
                        <p class="text-sm font-medium text-slate-700 truncate"><?php echo e(auth()->user()->name); ?></p>
...
</html><?php /**PATH C:\Users\Baihaqi\Documents\sistem_pengiriman\resources\views/layouts/app.blade.php ENDPATH**/ ?>