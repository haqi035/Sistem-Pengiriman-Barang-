...
<?php $__env->startSection('page-title','Laporan Pengiriman'); ?>
...
<div class="card p-5 mb-6">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        <div>
            ...
            <input type="date" name="start_date" value="<?php echo e($start); ?>" class="border border-blue-100 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 bg-blue-50/30">
        </div>
        <div>
            <label class="block text-xs font-medium text-slate-500 mb-1.5">Sampai Tanggal</label>
            <input type="date" name="end_date" value="<?php echo e($end); ?>" class="border border-blue-100 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300 bg-blue-50/30">
        </div>
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="card p-5 text-center">
        <p class="text-2xl font-bold text-blue-900"><?php echo e($summary['total_orders']); ?></p>
        <p class="text-xs text-slate-500 mt-1">Total Order</p>
    </div>
    <div class="card p-5 text-center">
        <p class="text-2xl font-bold text-green-600"><?php echo e($summary['delivered_orders']); ?></p>
        <p class="text-xs text-slate-500 mt-1">Terkirim</p>
    </div>
    <div class="card p-5 text-center">
        <p class="text-2xl font-bold text-yellow-600"><?php echo e($summary['pending_orders']); ?></p>
        <p class="text-xs text-slate-500 mt-1">Pending</p>
    </div>
    <div class="card p-5 text-center">
        <p class="text-lg font-bold text-emerald-600">Rp <?php echo e(number_format($summary['total_revenue'],0,',','.')); ?></p>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-blue-50">
                ...
                <tr>
                    <td class="py-3 pr-4 text-sm font-medium text-blue-600"><?php echo e($o->resi_number); ?></td>
                    ...
                    <td class="py-3 pr-4 text-sm font-semibold">Rp <?php echo e(number_format($o->total_cost,0,',','.')); ?></td>
                    <td class="py-3 pr-4"><span class="badge-<?php echo e($o->current_status); ?> px-2 py-0.5 rounded-full text-xs font-semibold"><?php echo e($o->status_label); ?></span></td>
...
const st = <?php echo json_encode($by_status, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Baihaqi\Documents\sistem_pengiriman\resources\views/admin/reports/index.blade.php ENDPATH**/ ?>