...
<div class="mb-6 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white">
    ...
    <a href="<?php echo e(route('customer.orders.create')); ?>" class="inline-flex items-center gap-2 mt-4 bg-white text-blue-600 font-semibold text-sm px-5 py-2.5 rounded-xl hover:bg-blue-50 transition shadow-lg">
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="card p-5 text-center">
        ...
        <p class="text-2xl font-bold text-blue-900"><?php echo e($stats['total']); ?></p>
    ...
    <div class="card p-5 text-center">
        ...
        <p class="text-2xl font-bold text-blue-900"><?php echo e($stats['transit']); ?></p>
...
<div class="card p-6">
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('customer.orders.index')); ?>" class="text-sm text-blue-500 hover:text-blue-700">Lihat Semua →</a>
    </div>
    <div class="space-y-3">
        ...
        <a href="<?php echo e(route('customer.orders.show',$o)); ?>" class="flex items-center justify-between p-4 bg-blue-50/60 hover:bg-blue-100/60 rounded-xl transition">
            <div>
                ...
                <p class="text-xs text-blue-400 capitalize"><?php echo e($o->service_type); ?></p>
            </div>
            <div class="text-right">
                <span class="badge-<?php echo e($o->current_status); ?> px-2.5 py-0.5 rounded-full text-xs font-semibold block mb-1"><?php echo e($o->status_label); ?></span>
                <p class="text-xs font-semibold text-slate-600">Rp <?php echo e(number_format($o->total_cost,0,',','.')); ?></p>
            </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="py-8 text-center text-slate-400">
            <i class="fas fa-box text-3xl text-blue-200 mb-2 block"></i>
            <p class="text-sm">Belum ada order. <a href="<?php echo e(route('customer.orders.create')); ?>" class="text-blue-500 hover:underline">Kirim sekarang!</a></p>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Baihaqi\Documents\sistem_pengiriman\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>