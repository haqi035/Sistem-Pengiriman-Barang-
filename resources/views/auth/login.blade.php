    ...
    <form method="POST" action="{{route('login')}}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="email" name="email" value="{{old('email')}}" required placeholder="admin@shipper.com"
...
<div class="text-center mt-4">
    <a href="{{route('tracking')}}" class="text-sm text-blue-500 hover:text-blue-700 font-medium">
